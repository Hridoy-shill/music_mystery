...
const AllClasses = () => {
    ...
    return (
        <div className='grid grid-cols-3 p-10 gap-4'>
            {
                classes.map(singleClass => <div key={singleClass._id} singleClass={singleClass} className="card w-full p-4 mx-auto border-2 hover:border-teal-500 duration-700">
                    ...
                    <div className="mt-5">
                        ...
                        <button className='btn w-full bg-teal-500 hover:bg-teal-500 text-base font-bold mt-10'>Add to Cart</button>
                    </div>
                </div>)
            }
        </div>
