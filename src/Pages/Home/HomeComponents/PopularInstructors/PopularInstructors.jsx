    ...
    return (
        <div>
            ...
            <div className='grid md:grid-cols-2 gap-3 p-10'>
                {
                    popularMusicians.map(popularMusician => <div className="card card-side bg-base-100 shadow-xl w-full p-10 gap-4 items-center border-2 hover:border-teal-500 mt-3 duration-500 transition ease-in-out delay-150 hover:-translate-y-3">
                        <div className='w-[30%]'>
                            <img className='rounded-md' src={popularMusician.photoURL} />
                        </div>
